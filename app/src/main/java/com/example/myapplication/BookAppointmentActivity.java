...
//        editText not editable, they display all the details from previous activity to next activity
        ed1.setKeyListener(null);
        ed2.setKeyListener(null);
        ed3.setKeyListener(null);
        ed4.setKeyListener(null);

//        fetch the data with the help of intent
        Intent it = getIntent();
...
//        Display all this variable data to the editText
        tv.setText(title);
