...
public class LabTestActivity extends AppCompatActivity {
    ...
    private String[][] packages =
            {
                    {"Package 1: Full Body Checkup", "", "", "", "699"},
                    {"Package 2: COVID-19 Antibodies", "", "", "", "234"},
                    {"Package 3: Immunity Check", "", "", "", "499"},
                    {"Package 4: Thyroid Check", "", "", "", "369"},
                    {"Package 5: Blood Glucose Fasting", "", "", "", "599"},
            };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i=0; i<packages.length; i++){
            ...
            item.put("line5", "Total Cost: R"+packages[i][4]);
            list.add(item);
        }
